...
import com.crowdio.mcc_phase3.data.device.DeviceInfoManager
...
class DeviceInfoCollector(private val context: Context) {
     ...
     */
    private fun getCpuModelFromDeviceInfo(deviceInfo: com.crowdio.mcc_phase3.data.models.DeviceInfo): String {
     ...
     */
    private fun getNetworkTypeName(networkInfo: com.crowdio.mcc_phase3.data.models.NetworkInfo): String? {
        if (!networkInfo.isConnected) return null
        
        return when (networkInfo.connectionType) {
            com.crowdio.mcc_phase3.data.models.ConnectionType.WIFI -> "WiFi"
            com.crowdio.mcc_phase3.data.models.ConnectionType.MOBILE -> "Mobile"
            com.crowdio.mcc_phase3.data.models.ConnectionType.ETHERNET -> "Ethernet"
            else -> "Unknown"
        }
    }
     ...
     */
    private fun estimateNetworkSpeed(networkInfo: com.crowdio.mcc_phase3.data.models.NetworkInfo): Float {
        if (!networkInfo.isConnected) return 0f
        
        return when (networkInfo.connectionType) {
            com.crowdio.mcc_phase3.data.models.ConnectionType.WIFI -> 50f // Conservative WiFi estimate
            com.crowdio.mcc_phase3.data.models.ConnectionType.ETHERNET -> 100f // Ethernet estimate
            com.crowdio.mcc_phase3.data.models.ConnectionType.MOBILE -> 10f // Mobile data estimate
            else -> 0f
        }
    }
